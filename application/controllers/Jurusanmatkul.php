...
class JurusanMatkul extends CI_Controller {
    ...
    public function index()
	{
		$data = [
			...
			'judul'	=> 'Mata Kuliah Jurusan',
			'subjudul'=> 'Data Mata Kuliah Jurusan'
		];
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Mata Kuliah Jurusan',
			'subjudul'	=> 'Tambah Data Matkul Jurusan',
	...
	public function edit($id)
	{
		$data = [
			'user' 			=> $this->ion_auth->user()->row(),
			'judul'			=> 'Edit Mata Kuliah Jurusan',
			'subjudul'		=> 'Edit Data Mata Kuliah Jurusan',
