<div class="box">
    ...
    <div class="box-body">
        <ul class="alert alert-info" style="padding-left: 40px">
            <li>Silakan impor data dari excel, dengan menggunakan format yang disediakan.</li>
            <li>Data tidak boleh kosong, semua harus diisi.</li>
            <li>Untuk data jurusan, hanya dapat diisi dengan menggunakan ID Jurusan. <a data-toggle="modal" href="#jurusanId" style="text-decoration:none" class="btn btn-xs btn-primary">View ID</a>.</li>
        </ul>
