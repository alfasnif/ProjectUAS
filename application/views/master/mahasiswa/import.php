<div class="box">
    ...
    <div class="box-body">
        <ul class="alert alert-info" style="padding-left: 40px">
            ...
            <li>Untuk data Kelas, hanya dapat diisi dengan menggunakan ID Kelas.<a data-toggle="modal" href="#kelasId" style="text-decoration:none" class="btn btn-xs btn-primary">View ID</a>.</li>
        </ul>
