            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <div class="form-group col-sm-12">
                            <label for="bobot" class="control-label">Bobot Penilaian</label>
                            <input required="required" value="1" type="number" name="bobot" placeholder="Bobot Penilaian" id="bobot" class="form-control">
