<div class="box">
    ...
    <div class="box-body">
        <button type="button" onclick="bulk_delete()" class="btn btn-sm btn-flat btn-danger"><i class="fa fa-trash"></i> Delete</button>
        <div class="pull-right">
            <a href="<?=base_url('ujian/add')?>" class="btn bg-blue btn-sm btn-flat"><i class="fa fa-plus"></i> Buat Sesi Ujian</a>
