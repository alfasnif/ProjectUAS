    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label for="tgl_mulai">Mulai Pengerjaan</label>
                    <input name="tgl_mulai" type="text" class="datetimepicker form-control" placeholder="Waktu Mulai">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                    <label for="tgl_selesai">Selesai Pengerjaan</label>
                    <input name="tgl_selesai" type="text" class="datetimepicker form-control" placeholder="Waktu Selesai">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                    <label for="waktu">Durasi</label>
                    <input placeholder="Dalam Menit" type="number" class="form-control" name="waktu">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                    ...
                    <select name="jenis" class="form-control">
                        ...
                        <option value="Random">Essay</option>
                        <option value="Sort">Pilihan Ganda</option>
                    </select>
                    <small class="help-block"></small>
                </div>
